...
<body>
    ...
    <nav id="myNavbar" class="navbar navbar-dark  sticky-top">
        <h1><a href="index.php"><img src="images/logosony.png" height="75"></a></h1>
            ...
            if(isset($_SESSION['email'])){
                if($_SESSION['role']=='partenaire'){
                    //Si role partenaire alors il ne peut acceder qu'aux ventes et qu'aux partenaires
                    echo '
                ...
                /*echo '
                    ...
                    <a href="index.php?page=1">
                        <img src="images/label.jpeg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=2">
                        <img src="images/partenaire.jpeg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=3">
                        <img src="images/agent.png" width="50" height="50" />
                    </a>
                    <a href="index.php?page=4">
                        <img src="images/artiste.jpeg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=8">
                        <img src="images/categorie.png" width="50" height="50" />
                    </a>
                    <a href="index.php?page=9">
                        <img src="images/album.jpg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=10">
                        <img src="images/chanson.png" width="50" height="50" />
                    </a>
                    <a href="index.php?page=11">
                        <img src="images/vente.jpg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=5">
                        <img src="images/deconnexion.jpeg" width="50" height="50" />
                    </a>
                    <a href="index.php?page=7">
                        <img src="images/profil.png" width="50" height="50" />
                    </a>'; */
            }
        ...
        <?php
            ...
            if(isset($_SESSION['email'])){
                echo "<p></br></br>Bonjour ".$_SESSION['nom']." vous avez le rôle ".$_SESSION['role']."</p>";
            }
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-3 item">
                        <h3>LIENS DIRECTS</h3>
                        <ul>
                            <li><a href="index.php?page=4">Artistes</a></li>
                            <li><a href="index.php?page=3">Agents</a></li>
                            <li><a href="index.php?page=1">Labels</a></li>
                            <li><a href="index.php?page=2">Partenaires</a></li>
                            <li><a href="index.php?page=11">Ventes</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-3 item">
                        <h3>A PROPOS DE</h3>
                ...
                <p class="copyright">SONY MUSIC ENTERTAINMENT © 2022</p>
            </div>
        </footer>
    </div>
