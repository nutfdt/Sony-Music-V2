            ...
            if($_SESSION['role']=='label'){
                ...
                foreach($lesLabels as $unLabel){
                    if($unLabel['iduser']==$_SESSION['iduser']){
                        ...
                        echo "<tr>
                            <td></td>
                            <td><input type='submit' name='ModifierLabel' value='Modifier Label'/></td>
                        </tr>";
                    }
                }
            }
                ...
                foreach($lesPartenaires as $unPartenaire){
                    if($unPartenaire['iduser']==$_SESSION['iduser']){
                        ...
                        echo "<tr>
                            <td></td>
                            <td><input type='submit' name='ModifierPartenaire' value='Modifier Partenaire'/></td>
                        </tr>";
                    }
                }
            }
                ...
                foreach($lesAgents as $unAgent){
                    if($unAgent['iduser']==$_SESSION['iduser']){
                        ...
                        echo "<tr>
                            <td></td>
                            <td><input type='submit' name='ModifierAgent' value='Modifier Agent'/></td>
                        </tr>";
                ...
                foreach($lesArtistes as $unArtiste){
                    if($unArtiste['iduser']==$_SESSION['iduser']){
                        ...
                        echo "<tr>
                            <td></td>
                            <td><input type='submit' name='ModifierArtiste' value='Modifier Artiste'/></td>
                        </tr>";
                ...
                echo "<tr>
                        <td></td>
                        <td><input type='submit' name='ModifierAdmin' value='Modifier Admin'/></td>
                </tr>";
